...
class AppLogic:
    ...
    def update_temperatures(self):
        if self.plugin_sensor and hasattr(self.plugin_sensor, 'get_cpu_temperature'):
            self.cpu_temp = self.plugin_sensor.get_cpu_temperature()
            self.gpu_temp = self.plugin_sensor.get_gpu_temperature()
            self.main_window.after(0, self.main_window.update_temps, self.cpu_temp, self.gpu_temp)
